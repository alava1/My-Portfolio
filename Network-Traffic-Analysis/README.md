...
- Observed requests, responses, and packet flow patterns
...
- TCP traffic helps show connection establishment, communication flow, and session behavior
...
- Analyze more complex packet captures
- Document suspicious traffic scenarios
- Include screenshots of packet analysis
- Add example findings from different protocol investigations
- Expand the project into a mini incident investigation case study
