...
- Applied basic security-focused configuration changes
- Reviewed firewall or network access settings
...
- Include screenshots or command outputs from the hardening process
- Add a checklist of security improvements applied
- Expand the project to cover additional Linux security controls
- Document before-and-after hardening observations
